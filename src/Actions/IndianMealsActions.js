...
export const getAllIndianMealsActions = ()=>async(dispatch)=>{
    ...
    try {
        const response = await axios.get('https://yumyard-server.onrender.com/api/indianmeals/getallindianmeals');
...
export const getFilteredIndianMeals = (searchValue, category) => async (dispatch) => {
  ...
  export const deleteIndianMeal = (productId)=>async(dispatch)=>{
    ...
    try{
      const response = await axios.post('https://yumyard-server.onrender.com/api/indianmeals/deleteindianmeal',{productId});
  ...
  export const addIndianMeal = (product)=>async (dispatch)=>{
    ...
    try{
    const response = await axios.post('https://yumyard-server.onrender.com/api/indianmeals/addnewindianmeal',{product})
    ...
    export const getIndianMealByIdAction  = (productId)=>async(dispatch)=>{
      ...
      try{
      const response = await axios.post('https://yumyard-server.onrender.com/api/indianmeals/getbyid',{productId});
    ...
    export const editIndianMeal = (product)=>async (dispatch)=>{
      ...
      try{
      const response = await axios.post('https://yumyard-server.onrender.com/api/indianmeals/editindianmeal',{product})
