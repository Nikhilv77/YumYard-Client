...
export const getAllFeedbackActions = ()=>async(dispatch)=>{
    ...
    try {
        const response = await axios.get('https://yumyard-server-erfw.onrender.com/api/feedbacks/getallfeedbacks');
...
export const submitFeedbackActions = (data)=> async(dispatch)=>{
    ...
    try {
        const response = await axios.post('https://yumyard-server-erfw.onrender.com/api/feedbacks/submitfeedback',{data})
