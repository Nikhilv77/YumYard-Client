...
export const getAllFeedbackActions = ()=>async(dispatch)=>{
    ...
    try {
        const response = await axios.get('https://yumyard-server.cyclic.app/api/feedbacks/getallfeedbacks');
...
export const submitFeedbackActions = (data)=> async(dispatch)=>{
    ...
    try {
        const response = await axios.post('https://yumyard-server.cyclic.app/api/feedbacks/submitfeedback',{data})
