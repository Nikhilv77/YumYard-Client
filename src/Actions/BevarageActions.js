...
try {
    const response = await axios.get('/api/bevarages/getallbevarages')
...
export const getFilteredBevarages = (searchValue, category) => async (dispatch) => {
  ...
  export const deleteBevarage= (productId)=>async(dispatch)=>{
    ...
    try{
      const response = await axios.post('/api/bevarages/deletebevarage',{productId});
  ...
  export const addBevarage = (product)=>async (dispatch)=>{
    ...
    try{
    const response = await axios.post('/api/bevarages/addnewbevarage',{product})
    ...
    export const getBevarageByIdAction  = (productId)=>async(dispatch)=>{
      ...
      try{
      const response = await axios.post('/api/bevarages/getbyid',{productId});
    ...
    export const editBevarage = (product)=>async (dispatch)=>{
      ...
      try{
      const response = await axios.post('/api/bevarages/editbevarage',{product})
