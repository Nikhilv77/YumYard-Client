...
export const getFilteredBevarages = (searchValue, category) => async (dispatch) => {
  ...
  export const deleteBevarage= (productId)=>async(dispatch)=>{
    ...
    try{
      const response = await axios.post('https://yumyard-server.cyclic.app/api/bevarages/deletebevarage',{productId});
  ...
  export const addBevarage = (product)=>async (dispatch)=>{
    ...
    try{
    const response = await axios.post('https://yumyard-server.cyclic.app/api/bevarages/addnewbevarage',{product})
    ...
    export const getBevarageByIdAction  = (productId)=>async(dispatch)=>{
      ...
      try{
      const response = await axios.post('https://yumyard-server.cyclic.app/api/bevarages/getbyid',{productId});
    ...
    export const editBevarage = (product)=>async (dispatch)=>{
      ...
      try{
      const response = await axios.post('https://yumyard-server.cyclic.app/api/bevarages/editbevarage',{product})
