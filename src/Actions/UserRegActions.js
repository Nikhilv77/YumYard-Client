...
export const removeUser = (userId,adminAction) => async (dispatch) => {
  ...
  try {
    const response = await axios.post("/api/users/removeusers", { userId });
...
export const userAlreadyExistsAction = (user) => async (dispatch) => {
  ...
  try {
    const response = await axios.post("/api/users/alreadyexists", user);
...
export const updatePasswordAction = (info) => async (dispatch) => {
  ...
  try {
    const response = axios.post("/api/users/updatepassword", info);
...
export const getUserByEmail = (email) => async (dispatch) => {
  ...
  try {
    const response = await axios.post("/api/users/getuserbyemail", email);
