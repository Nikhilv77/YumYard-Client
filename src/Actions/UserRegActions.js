...
export const getAllUsers = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get("https://yumyard-server.cyclic.app/api/users/getusers");
...
export const userAlreadyExistsAction = (user) => async (dispatch) => {
  ...
  try {
    const response = await axios.post("https://yumyard-server.cyclic.app/api/users/alreadyexists", user);
...
export const updatePasswordAction = (info) => async (dispatch) => {
  ...
  try {
    const response = axios.post("https://yumyard-server.cyclic.app/api/users/updatepassword", info);
...
export const getUserByEmail = (email) => async (dispatch) => {
  ...
  try {
    const response = await axios.post("https://yumyard-server.cyclic.app/api/users/getuserbyemail", email);
