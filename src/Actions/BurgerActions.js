...
try {
    const response = await axios.get('https://yumyard-server.cyclic.app/api/burgers/getallburgers')
...
export const getFilteredBurgers = (searchValue, category) => async (dispatch) => {
  ...
  export const deleteBurgers = (productId)=>async(dispatch)=>{
    ...
    try{
      const response = await axios.post('https://yumyard-server.cyclic.app/api/burgers/deleteburger',{productId});
  ...
  export const addBurger = (product)=>async (dispatch)=>{
    ...
    try{
    const response = await axios.post('https://yumyard-server.cyclic.app/api/burgers/addnewburger',{product})
    ...
    export const getBurgerByIdAction  = (productId)=>async(dispatch)=>{
      ...
      try{
      const response = await axios.post('https://yumyard-server.cyclic.app/api/burgers/getbyid',{productId});
    ...
    export const editBurger = (product)=>async (dispatch)=>{
      ...
      try{
      const response = await axios.post('https://yumyard-server.cyclic.app/api/burgers/editburger',{product})
