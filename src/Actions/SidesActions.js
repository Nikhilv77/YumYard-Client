...
try {
    const response = await axios.get('https://yumyard-server-erfw.onrender.com/api/sides/getallsides')
...
export const getFilteredSides = (searchValue, category) => async (dispatch) => {
  ...
  export const deleteSides = (productId)=>async(dispatch)=>{
    ...
    try{
      const response = await axios.post('https://yumyard-server-erfw.onrender.com/api/sides/deleteside',{productId});
  ...
  export const addSide = (product)=>async (dispatch)=>{
    ...
    try{
    const response = await axios.post('https://yumyard-server-erfw.onrender.com/api/sides/addnewside',{product})
    ...
    export const getSideByIdAction  = (productId)=>async(dispatch)=>{
      ...
      try{
      const response = await axios.post('https://yumyard-server-erfw.onrender.com/api/sides/getbyid',{productId});
    ...
    export const editSide = (product)=>async (dispatch)=>{
      ...
      try{
      const response = await axios.post('https://yumyard-server-erfw.onrender.com/api/sides/editside',{product})
